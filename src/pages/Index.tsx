        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-slate-800">OneSight</h1>
                <p className="text-sm text-slate-600">Assistente Ecografico Veterinario</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <div className="text-right">
                <p className="text-sm font-medium text-slate-700">Dr. Mario Rossi</p>
                <p className="text-xs text-slate-500">Clinica Veterinaria Milano</p>
              </div>

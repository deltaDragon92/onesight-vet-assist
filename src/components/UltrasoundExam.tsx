...
const UltrasoundExam = ({
  ...
  return <div className="w-full ">
        ...
        <Card className="lg:col-span-3 bg-slate-100 shadow-lg">
          <CardContent className="p-0 relative">
            <div className="aspect-video bg-gradient-to-br from-slate-100 to-slate-200 relative overflow-hidden flex items-center justify-center">
              ...
              {!aiGuidanceMode && <div className="bg-white rounded-lg shadow-lg p-8 max-w-md mx-4 text-center border">
                  ...
                  <div className="space-y-4">
                    ...
                    <Button onClick={() => setAiGuidanceMode(true)} variant="outline" className="w-full border-2 border-blue-500 text-blue-600 hover:bg-blue-50 h-12">
      ...
      {aiGuidanceMode && <div className="fixed inset-0 z-50 bg-slate-100 flex flex-col">
          {/* Fixed Header */}
            ...
            <div className="flex-[2] min-w-0 h-[90vh] md:h-auto">
              <Card className="h-full bg-[#0F1013] border-slate-700 shadow-lg">
                <CardContent className="p-0 h-full relative">
                  <video ref={videoRef} className="w-full h-full object-cover rounded-lg" autoPlay muted={false} style={{
                backgroundColor: '#0F1013'
                  ...
                  <div className="absolute bottom-4 left-4 flex items-center space-x-3">
                    <Button onClick={toggleVideoPlayback} size="sm" className="bg-white/10 hover:bg-white/20 text-white border-white/20">
